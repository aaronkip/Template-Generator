...
import 'package:flutter/material.dart' hide Divider, Chip, Colors, Card;
...
class EditTemplatePage extends StatefulWidget {
  const EditTemplatePage({Key? key}) : super(key: key);
    ...
    return Material(
      child: ScaffoldPage.scrollable(
        header: const PageHeader(
            title: Center(child: Text('Edit Selected Template'))),
        children: [
          ...
          Row(
            children: [
              ...
              Chip.selected(
                ...
                onPressed: () {
                  if (selectedList['sections'].isEmpty) {
                    showTopSnackBar(
                      context,
                      Center(
                        child: Text(
                    ...
                    if (nameEditingController.text.isNotEmpty) {
                      ...
                      FirebaseHelper().saveEditedTemplate(templateName, uid);
                      print(uid);
                    } else {
                      showTopSnackBar(
                        context,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    "${selectedList['sections'][index]['data']['choices']}",
                                    style: const TextStyle(
